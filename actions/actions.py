...
class LeaveSubmit(Action):
    ...
    def run(
        ...
        dispatcher.utter_message("Thanks for providing the message. We have sent a mail regarding your absence to the school officials")
        return []
...
class EmailIDS(Action):
    ...
    def run(self, dispatcher: "CollectingDispatcher", tracker: Tracker, domain: "DomainDict") -> List[Dict[Text, Any]]:
        ...
        if r != None:
            ...
            dispatcher.utter_message(Template="utter_confirming_id")
